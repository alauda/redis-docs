---
weight: 20
sourceSHA: 84681f824c7f267c2ec25413135419e3073d364adfb8d46bc5587c0c24d2ad3a
---
...
在 **Redis** -> **实例详情** 页面，点击 **巡检** 按钮以启动实例的巡检。
...
巡检完成后，您可以在 **Redis** -> **实例详情** 页面中的巡检报告点击 **查询** 按钮，以查看巡检结果。
