...
The Data Service View page provides a BigKey detection function that allows you to detect BigKey in Redis instances using this capability.
...
In **Data Service** -> **Redis** -> **Instance Details Page**, click the **Inspect** button to start the instance inspection, as shown in the figure below:

![BigKey Detection](../assets/44redis-bigkey-inspect-entry.png)
...
Upon completion of the inspection, you can click the **Query** button in the inspection report on the **Data Service** -> **Redis** -> **Instance Details Page** to view the inspection results.
