...
Below is the lifecycle schedule for released versions of Alauda Cache Service E1:

{/* TODO(release): fill in the v5.1.x release date and derived support dates before publishing. */}
...
* A new patch version of Alauda Cache Service E1 is released as needed to address bugs and security vulnerabilities. Patch releases do not introduce new features.
