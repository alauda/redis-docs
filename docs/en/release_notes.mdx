...
|:-------------------------------------------|------------------------|:------------|
| v4.1.7                                     | 5.0.16, 6.0.22, 7.2.15 | v4.1, v4.2  |
| v4.1.6                                     | 5.0.15, 6.0.21, 7.2.14 | v4.1, v4.2  |
| v4.1.3                                     | 5.0.15, 6.0.21, 7.2.13 | v4.1, v4.2  |
...
This release rebuilds the operator and its sub-images to address system and application vulnerabilities. See the security advisory (errata) for the full CVE list.

### Fixed Issues

{/* release-notes-for-bugs?template=mw-redis-v4.1.7-fixed&project=ECO */}
...
{/* release-notes-for-bugs?template=mw-redis-v4.1.3-fixed&project=Middleware */}

## v4.1.2

### Fixed Issues

{/* release-notes-for-bugs?template=mw-redis-v4.1.2-fixed&project=Middleware */}

## v4.1.1

### Fixed Issues

{/* release-notes-for-bugs?template=mw-redis-v4.1.1-fixed&project=Middleware */}
