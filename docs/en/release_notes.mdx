...
Alauda Cache Services for Redis OSS's lifecycle havs been decoupled from platform's, which means when customer needs a certain feature or a bug fix, Redis team can release immediately instead of waiting for the platform release together.
