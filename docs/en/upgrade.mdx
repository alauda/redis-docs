...
Because ACP v4.3 requires Alauda Cache Service E1 v5.0.x, and v5.0.x no longer supports Redis `5.0`, you must first upgrade every Redis `5.0` instance to a supported version (`6.0` or `7.2`) **before** upgrading from an ACP version earlier than v4.3 to v4.3.
