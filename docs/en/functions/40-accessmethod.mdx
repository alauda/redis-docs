...
Address retrieval path: **Instance Details** > **Access Method** > **Access within the Cluster**
...
Address retrieval path: **Instance Details** > **Access Method** > **Access from outsize the Cluster**
