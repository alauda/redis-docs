...
<Directive type="info" title="Redis 8.4">
The new module also targets Redis `8.4`, but Alauda Cache Service for Redis OSS v5.1.0 ships no Redis `8.4` server image. See [Release Notes](../../release_notes.mdx) for details.
</Directive>
