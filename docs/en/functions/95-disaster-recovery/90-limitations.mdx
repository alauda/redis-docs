...
The Proxy address in the disaster recovery instance does not guarantee high availability. If you use the NodePort address for the standby, you need a front-end load balancer to ensure high availability; you can also use MetalLB to achieve high-availability access to the Proxy.
