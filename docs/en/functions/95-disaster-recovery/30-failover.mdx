...
<Directive type="info" title="Applies to Disaster Recovery mode">
...
After the failed upstream returns to normal, it can be re-added to the replication group as a downstream instance of the promoted upstream. For the operation method, refer to [Set Up Disaster Recovery Replication](./20-setup.mdx).
