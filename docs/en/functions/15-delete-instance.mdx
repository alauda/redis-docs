...
<Tabs>
  ...
  <Tab label="Web Console">
    ...
    4. In the upper right corner of the **Instance Details** page, click the **Actions** button to expand the menu options.

    5. Click on **Delete** in the menu, and a deletion confirmation box will pop up.

    6. For instances with data persistence enabled, you can check "Delete PVC" to free up storage, or leave it unchecked to retain the data.
