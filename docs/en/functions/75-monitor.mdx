...
The intuitively presented monitoring data can provide decision support for operation and maintenance inspections or performance tuning, and a complete alert and notification mechanism will help ensure the stable operation of the database.
...
To create alerting policies for Redis, go to the **Alerts** > **Alert Policies** page in the Application Service (you can also use the platform's universal alerting function to create alerts).

### Configuring Alert Policies

To enable alerts, you must first create an alert policy in the Application Service. An alert policy describes the objects you want to monitor, under what conditions you wish to receive alerts, and how you will be notified about the relevant alerts.
...
With the above alert indicators, quick creation of alert policies is achievable. In addition to built-in alert indicators, custom alert indicators can also be defined in the following format:
...
For more information about configuring and using alerts, please refer to <ExternalSiteLink name="acp" href="appservice/unified-om/alert-policy-mgt/index" children="Alert Policy Management" />.
