...
Alauda Cache Service E1 supports dynamic updates to Pod scheduling configurations when node taints change. You can add, modify, or remove Pod tolerations without disrupting the ongoing Redis service.
