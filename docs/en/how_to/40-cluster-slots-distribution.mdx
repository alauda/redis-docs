...
Here, `spec.replicas.cluster.shards` is mainly set. The number of shards set must be consistent with the number of shards specified in the `spec.replicas.cluster.shard` field. The `spec.replicas.cluster.shards[].slots` field supports formats such as `0-5461`,`0-5460,5461`, and `0-1000,1001,1002-5461`.
