...
This page covers patch version upgrades. Moving an instance with cross-datacenter replication enabled between Redis minor versions has additional requirements — see [Upgrade a Disaster Recovery Group from Redis 6.0 to Redis 7.2](../functions/95-disaster-recovery/50-upgrade-6.0-to-7.2.mdx).
</Directive>
