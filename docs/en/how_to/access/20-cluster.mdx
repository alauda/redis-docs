...
# How to Access Cluster Instances
...
Once the instance is created, you can check the access information used for **In-Cluster** access in the **Access Method** tab of the instance.

| Parameter                        | Description                     |
| ------------------------------- | ------------------------------- |
| **Connection Address (through internal routing of each shard)** | Internal routing name and port. |

### For Out-of-Cluster

- **Via Pod’s NodePort**: In the instance **Access Method** tab, clients can connect to Redis via the node access address within the **External Access - Via Pod’s NodePort** area.

- **Via Predixy [Not Recommended]**: Enable NodePort for Predixy for external access. Please note, **Predixy does not support exposing IPv6 addresses**.
