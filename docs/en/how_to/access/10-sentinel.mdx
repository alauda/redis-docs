...
|--------------------------|---------------------------------------|
| **Connection Address**   | Service name and port pair list. |
...
| Parameter                  | Description                                               |
|----------------------------|-----------------------------------------------------------|
| **Sentinel Node Access Address** | Used for accessing the instance from outside the cluster, including the IP addresses and ports of the corresponding services of the sentinels. |
